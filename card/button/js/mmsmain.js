...
$(function () {
  ...
  $('#send_btn_xmsg1').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), "drop https://www.youtube.com/watch?v=XxJKnDLYZz4");
  });

  $('#send_btn_xmsg2').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), "drop https://www.youtube.com/watch?v=6ake466npaI");
  });

  $('#send_btn_xmsg3').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), 'drop https://www.youtube.com/watch?v=yk2CUjbyyQY');
  });

  $('#send_btn_xmsg4').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), 'drop http://cdn.ypcall.com/users/A2A36DCB-A1FE-48C0-8799-741926446DDF/drive/robin/photo6305293337111930859.jpg');
  });

  $('#send_btn_xmsg5').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), 'drop https://www.youtube.com/watch?v=UG-el9xOAo0');
  });

  $('#send_btn_xmsg6').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), 'drop http://cdn.ypcall.com/miki/yp/djdemo/sugar.mp4');
  });

  $('#send_btn_xmsg7').on('click', function (e) {
    e.preventDefault();
    mmsSendXmsg(myFunction(), 'drop https://www.youtube.com/watch?v=KXOcAiAkqyg');
  });
